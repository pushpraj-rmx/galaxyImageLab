...
$u="91".$_REQUEST['mobile'];
$p=$_REQUEST['password'];
$did='1';
$curl = curl_init();
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://livehealth.in/login/app/',
  ...
  CURLOPT_POSTFIELDS => array('username' => $u,'password' => $p,'developerId' => $did),
));
...
if($code==200){$userval="";header("location:reports.php"); $_SESSION["token"]=$decoded_json->token;}
